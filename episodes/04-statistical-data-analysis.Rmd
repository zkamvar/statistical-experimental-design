...
blood_volume <- rbind(blood_volume, 
                      as.data.frame(matrix(rnorm(n = 25, mean = 4, sd = 1), 
                                           nrow = 25)))
triaxial_cpm <- as.data.frame(matrix(rnorm(n = 25, mean = 571, sd = 193), 
                                     nrow = 25))
triaxial_cpm <- rbind(triaxial_cpm,
                      matrix(rnorm(n = 25, mean = 408, sd = 182), 
                                     nrow = 25))
fitness <- rep(c("fit", "unfit"), each = 25) 
blood_volume <- cbind(blood_volume, triaxial_cpm, fitness)
names(blood_volume) <- c("blood_volume", "physical_activity", "CR fitness")
